...
<body>
    ...
    <!-- header area end -->
    <!-- Sidebar start -->
    <div class="sidebar" style="background: color #ea00ea;">
        <center>
            <img src="gambar/admin.png" class="profile_admin" alt="">
            <h4>Admin</h4>
        </center>
        <a href="?page=dashboard"><i class="fas fa-desktop"></i> <span>Home</span></a>
        <a href="?page=kategori"><i class="far fa-comment"></i> <span>Tambah data</span></a>
        <a href="?page=produk"><i class="fas fa-newspaper"></i> <span>Tabel Bunga</span></a>
